...
public class data {
    public static String [] channels= {"1arxi", "rustavi2", "imedi", "GDS", "kavkasia", "silkuniversali", "1arxi", "rustavi2", "imedi", "GDS", "kavkasia", "silkuniversali"};
    public static int [] aida = {826, 808, 818, 820, 519, 544,826, 808, 818, 820, 519, 544};
    public static int [] images = {R.drawable.pirveli, R.drawable.arxi, R.drawable.arxi, R.drawable.arxi, R.drawable.arxi,
            R.drawable.arxi, R.drawable.pirveli, R.drawable.arxi, R.drawable.arxi, R.drawable.arxi, R.drawable.arxi,
            R.drawable.arxi};
    public static String [] detail={"1 Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. " ,
